<template>
    <div>
        <h1>{{ t('dashboard.navigation.nav-study.plant-lexicon.items.catalogue') }}</h1>
        <p>Plant catalogue placeholder.</p>
    </div>
</template>
...
<script setup lang="ts">
    ...
    set([
        ...
        { text: t('dashboard.navigation.nav-study.plant-lexicon.items.catalogue') },
    ]);
</script>
