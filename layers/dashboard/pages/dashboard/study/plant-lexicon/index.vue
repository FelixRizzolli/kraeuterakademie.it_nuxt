<template>
    <div>
        <h1>{{ t('dashboard.navigation.nav-study.plant-lexicon.title') }}</h1>
        <p>Plant lexicon overview placeholder.</p>
    </div>
</template>
...
<script setup lang="ts">
    ...
    set([
        ...
        { text: t('dashboard.navigation.nav-study.plant-lexicon.title') },
    ]);
</script>
