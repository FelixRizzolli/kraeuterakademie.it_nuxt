<template>
    <div>
        <h1>{{ t('dashboard.navigation.nav-study.plant-lexicon.items.plant-groups') }}</h1>
        <p>Plant groups placeholder.</p>
    </div>
</template>
...
<script setup lang="ts">
    ...
    set([
        ...
        { text: t('dashboard.navigation.nav-study.plant-lexicon.items.plant-groups') },
    ]);
</script>
